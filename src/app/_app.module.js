(function (angular) {
    ...
    angular.module("ngApplication").config([
        ...
        function ($locationProvider, $stateProvider, $urlRouterProvider, $qProvider, GlobalConstants,
            ...
            $translateProvider.preferredLanguage('en_US'); //todo global configból ha nincs profile
    ...
    angular.module("ngApplication").factory('MissingTranslationHandlerFactory', ['$rootScope', function ($rootScope) {
    ...
    angular.module("ngApplication").controller("ngApplicationController", [
        ...
        function ($scope, $rootScope, $location, $state, $timeout, $animate, $anchorScroll, $translate, $window,
                  GlobalConstants, AuthService, HeaderMessageManager, GlobalFunctionsTimer, GlobalFunctionsJQ) {
            ...
            var storedLanguage = AuthService.getCookie(GlobalConstants.settings.LANGUAGE);
            if (storedLanguage) {
            ...
            var storedLoginData = AuthService.getCookie(GlobalConstants.system.AUTH_TOKEN_KEY);
            if (storedLoginData) {
                AuthService.validateToken(storedLoginData).then(function (result) {
                    if (result) {
